...
import forge = require("./../src/crypto/forge");
import openssl = require("./../src/crypto/openssl");
...
describe("crypto", () => {
  ...
  const modulusStore: any[] = [];
  const exponentStore: any[] = [];
  const publicKeyStore: string[] = [];
